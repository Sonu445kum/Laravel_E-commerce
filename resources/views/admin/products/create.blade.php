...
@section('content')
<h1 class="text-3xl font-bold mb-6 text-purple-700">Add Product</h1>
...
<form action="{{ route('admin.products.store') }}" method="POST">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="image" class="w-full border rounded px-3 py-2" required>
    </div>
    <div class="mb-4">
    ...
    <button type="submit" class="px-6 py-2 bg-yellow-400 text-white rounded-full hover:bg-yellow-500 transition">Save Product</button>
</form>
@endsection
